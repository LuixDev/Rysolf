...
const Contact = () => {
  ...
  return (
    ...
    <div className='main'>
        ...
        <div style={{ position: 'absolute', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end', padding: '10px', color: '#9B9B9B', fontSize: '14px' }}>

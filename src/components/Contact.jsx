...
const Contact = () => {
  ...
  return (
    ...
    <div className='main'>
        ...
        <div style={{ position: 'absolute', top:60, left: 0, width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end', padding: '30px', color: '#9B9B9B', fontSize: '14px' }}>

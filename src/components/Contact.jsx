...
const Contact = () => {
  ...
  return (
    ...
    <div className='main'>
        ...
        <div style={{ position: 'absolute', top:100, left: 0, width: '90%', height: '90%', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end', padding: '30px', color: '#9B9B9B', fontSize: '14px' }}>

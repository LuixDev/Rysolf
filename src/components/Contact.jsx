...
const Contact = () => {
  ...
  return (
    ...
    <div className='main'>
        ...
        <div style={{ position: 'absolute', top:15, left: 15, width: '90%', height: '90%', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end', padding: '0px', color: '#9B9B9B', fontSize: '14px' }}>
